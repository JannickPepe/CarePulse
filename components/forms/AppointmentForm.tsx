...
export const AppointmentForm = ({userId, patientId, type = "create", appointment, setOpen, }: 
    {userId: string; patientId: string; type: "create" | "schedule" | "cancel"; appointment?: Appointment; setOpen?: Dispatch<SetStateAction<boolean>>; 
}) => {
    ...
    const onSubmit = async (values: z.infer<typeof AppointmentFormValidation>) => {
        ...
        // for the different status switch cases
        let status;
        switch (type) {
            case "schedule":
                status = "scheduled";
        ...
        try {
            if (type === "create" && patientId) {
                ...
                // send it to the backend in our appointment.actions
    ...
    // for the different buttonLabel switch cases
    let buttonLabel;
    switch (type) {
        case "cancel":
